...
const Hero = () => {
    return (
        <div className="relative bg-cover bg-center" style={{ backgroundImage: "url('/assets/image1.webp')" }}>
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-32 lg:py-32">
                <div className="oswald lg:grid lg:grid-cols-12 lg:gap-x-12">
                    <div className="lg:col-span-6 xl:col-span-5 mt-8">
                        ...
                        <div className="mt-10 flex items-center gap-x-6">
                            <a href="/services/appliance-installation" className="rounded-xl bg-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500">Our Services</a>
